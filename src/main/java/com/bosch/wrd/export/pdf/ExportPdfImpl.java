...
public class ExportPdfImpl implements ExportPdf {
	...
	public InputStream exportProjectTemplate(ProjectReviewDto dto) throws IOException, DocumentException {
		ProjectReviewHandlingPDF projectReview = new ProjectReviewHandlingPDF(dto);
		return projectReview.createPdf();
	}

	@Override
	public InputStream exportStearingCommiteeTemplate(StearingCommiteeDto dto) throws IOException, DocumentException {
		StearingCommiteeHandlingPDF stearingCommitee = new StearingCommiteeHandlingPDF(dto);
		return stearingCommitee.createPdf();
	}
